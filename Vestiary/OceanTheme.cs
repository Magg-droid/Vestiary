...
public class OceanTheme : ITheme
{
    ...
    public Vector4 RailBg          => new(0.06f, 0.08f, 0.10f, 1f);
    public Vector4 RailItemBgActive => new(0.14f, 0.18f, 0.24f, 1f);
    public Vector4 RailItemBgHovered => new(0.10f, 0.13f, 0.17f, 0.8f);
    public Vector4 RailTextActive  => new(0.80f, 0.84f, 0.88f, 1f);
    public Vector4 RailTextIdle    => new(0.48f, 0.52f, 0.56f, 0.9f);
    public Vector4 RailDivider     => new(0.18f, 0.22f, 0.26f, 0.6f);

    // ── Collection chips ─────────────────────────────
    public Vector4 ChipBg          => new(0.08f, 0.10f, 0.13f, 0.95f);
    public Vector4 ChipBgActive    => new(0.18f, 0.22f, 0.28f, 1f);
    public Vector4 ChipBgHovered   => new(0.13f, 0.16f, 0.20f, 0.9f);
    public Vector4 ChipText        => new(0.52f, 0.56f, 0.60f, 0.9f);
    public Vector4 ChipTextActive  => new(0.80f, 0.84f, 0.88f, 1f);
    public Vector4 ChipBorder      => new(0.24f, 0.28f, 0.32f, 0.6f);

    // ── Window chrome ────────────────────────────────
    public Vector4 WindowBg => new(0.05f, 0.07f, 0.09f, 1f);
}
